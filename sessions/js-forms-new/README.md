...
```
npx ghcd@latest neuefische/web-exercises/tree/main/sessions/js-forms-new/demo-start -i
```

You can check out the final version of this demo on
[🔗 **CodeSandbox**](https://codesandbox.io/s/github/neuefische/web-exercises/tree/main/sessions/js-forms-new/demo-end?file=/README.md)
or locally by running this command in your Terminal:
