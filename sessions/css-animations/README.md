...
```
npx ghcd@latest neuefische/web-exercises/tree/main/sessions/css-animations/demo-start
```

Demo End:

```
npx ghcd@latest neuefische/web-exercises/tree/main/sessions/css-animations/demo-end
```
