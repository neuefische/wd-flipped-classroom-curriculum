...
stored plain text. It is used by tools and websites like GitHub or Slack. It uses specific
...
You can always _go back to any prior commit_ and will have all the project files as they were when
you made the commit.
...
- When in doubt, describe _why_ you did something instead of _how_: "fix typo" instead of "replaced
  the letter a with an e in the second word"
...
GitHub is an online platform where you can store, share and collaborate on _remote_ git
...
be a valueable public asset for your future career. You can get in contact with many open source
