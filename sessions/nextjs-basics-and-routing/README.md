...
- Mention that we can easily deploy our Next.js projects to Vercel.
...
- Explain we need to configure the allowed domains if we use images from other domains (like `source.unsplash.com`).
