...
Find a template for a Slack message [here](self-directed-learning-week-7.md). Alternatively push the file to the students repository.
...
> The [challenges page](challenges-self-directed-learning-week-7.md) can be sent to the students via the `web-class-helper` tool.
