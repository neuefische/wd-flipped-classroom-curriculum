...
- Show the students the [web challenges workflow](https://github.com/wd-bootcamp/cohort-template/blob/main/docs/challenge-workflow.md). They have a copy in their cohort repository.
