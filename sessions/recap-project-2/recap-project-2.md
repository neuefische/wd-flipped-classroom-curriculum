# Recap 2: Quiz App - Interactivity
...
[Recap Project 2 Quiz App Template](https://github.com/neuefische/web-quiz-app-template)

Click on the button labeled "Use this template" to create a new repository in your Github account
based on this template. Afterwards you can clone the repository to start working on the code on your
computer.
...
![Quiz App form](./assets/quiz-app-form-page.png)
...
![Quiz App form with counter](./assets/quiz-app-form-page-with-counter.png)
